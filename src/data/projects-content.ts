...
export const PROJECTS_CONTENT: ProjectsContent = Object.freeze({
  ...
  [LANGUAGES.EN]: Object.freeze({
    ...
    'karma-forge': Object.freeze({
      title: 'Karma Forge',
      subtitle: 'Landing Page for Automation Agency | Frontend',
      description: 'Landing page for Karma Forge, a Costa Rican agency that transforms manual processes into automated digital solutions for SMEs. The site communicates three service packages with conversion-oriented design and SEO positioning.',
      problem: 'Costa Rica\'s SMEs face invisibility in search engines, customer loss due to lack of 24/7 availability, and chaotic paper-and-Excel operations that consume valuable time in repetitive manual tasks.',
      solution: 'I developed a conversion-oriented landing page with Astro that clearly presents the agency\'s value proposition: three service packages (Digital Presence, Connected Business and Internal System), with animations, basic SEO and mobile-first responsive design.',
      features: [
        'Mobile-first design with smooth animations and transitions',
        'Services section with three clear packages and pricing',
        'Value proposition oriented toward SME conversion',
        'Basic SEO optimization for search engine positioning',
        'Visual integration of automations with N8N, AI and Meta APIs',
        'Implementation in 7–15 business days as a key differentiator',
      ],
      challenges: [
        'Communicating a technical value proposition in a simple and persuasive way to a non-technical audience',
        'Designing an information architecture that guides the user from the problem to the solution',
        'Achieving high performance and SEO with Astro in static mode',
      ],
      metrics: [],
      role: 'Frontend Developer',
      imageAlt: 'Karma Forge landing page showing the hero with the tagline "If you do it by hand, make it software"',
    }),
  }),
});
